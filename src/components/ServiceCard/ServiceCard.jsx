...
const ServiceCard = ({ service }) => {
  ...
  return (
    <div>
      <div className="group flex flex-col max-w-sm bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7] p-5">
        <div className="w-11/12  h-72 mx-auto flex flex-col justify-center items-center  rounded-t-xl">
          <img
            src={serviceImg}
            className=" "
            alt=""
        ...
        <div className="mx-3">
          ...
          <div className="flex items-center gap-5">
            ...
            />
            <h4 className="text-gray-600 font-bold text-lg">{providerName}</h4>
          </div>
        </div>
